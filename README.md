...
campus venue captcha                 # 获取预约验证码
campus venue book -v JLH01 -s 14:00 -e 15:00 --captcha-id <id> --captcha-code <code>  # 预约
campus venue my                      # 查看我的预约
campus venue cancel <booking_id> -r "有其他安排"  # 取消预约 (原因必填)
